  ...
  if (!client) {
    return (
      <main className="p-6 text-center text-red-600">
        ...
        <p>The tracking ID <code className="bg-gray-100 px-2 py-1 rounded">{trackingId}</code> was not found.</p>
        <p className="mt-2">
          Please go back to the{' '}
          <a href="/create-order" className="text-blue-600 underline">order page</a>.
        </p>
      </main>
    )
  }
