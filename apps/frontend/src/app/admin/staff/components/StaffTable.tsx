...
import { Settings, ChevronDown, Edit2 } from 'lucide-react';
...
export const StaffTable = ({ staffs, loading, onRefresh }: StaffTableProps) => {
  ...
  const handleAccessToggle = async (staff: any) => {
          ...
          <table className="min-w-full text-sm text-black table-fixed">
            <thead>
              <tr className="bg-gray-100 text-black">
                {visibleColumns.name && (
                  <th className="px-4 py-2 text-left font-semibold w-1/5">Staff Name</th>
                )}
                {visibleColumns.email && (
                  <th className="px-4 py-2 text-left font-semibold w-1/5">Email</th>
                )}
                {visibleColumns.phone && (
                  <th className="px-4 py-2 text-left font-semibold w-1/6">Phone</th>
                )}
                {visibleColumns.status && (
                  <th className="px-4 py-2 text-left font-semibold w-1/8">Status</th>
                )}
                {visibleColumns.access && (
                  <th className="px-4 py-2 text-left font-semibold w-1/8">Access</th>
                )}
                      ...
                      <td className="px-4 py-3">
                        <label className="inline-flex items-center cursor-pointer">
                          <input
                            ...
                            onChange={() => handleAccessToggle(staff)}
