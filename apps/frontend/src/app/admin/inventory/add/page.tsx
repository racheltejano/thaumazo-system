...
export default function AdminAddInventoryPage() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow p-6 mb-6">
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() => router.push('/admin/inventory/table')}
              className="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg transition-colors mr-4"
            >
